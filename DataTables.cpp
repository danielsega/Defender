...
std::vector<AircraftData> initializeAircraftData()
{
	...
	data[Aircraft::Raptor].directions.push_back(Direction(80.f, +45.f));
	data[Aircraft::Raptor].directions.push_back(Direction(160.f, -45.f));
	data[Aircraft::Raptor].directions.push_back(Direction(80.f, +45.f));
...
std::vector<ProjectileData> initializeProjectileData()
{
	...
	data[Projectile::AlliedBullet].textureRect = sf::IntRect(176, 68, 13, 3);

	data[Projectile::EnemyBullet].damage = 10;
	data[Projectile::EnemyBullet].speed = 400.f;
	data[Projectile::EnemyBullet].texture = Textures::Entities;
	data[Projectile::EnemyBullet].textureRect = sf::IntRect(176, 65, 13, 3);
